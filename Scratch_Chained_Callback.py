...
app.layout = html.Div(style={'margin': '20px'}, children=[
    ...
    ], style={'margin-bottom': '20px'}),  # Space below the region selection
    ...
    ], style={'margin-bottom': '20px'}),  # Space below the country selection
    ...
    ], style={'margin-bottom': '20px'}),  # Space below the data type selection
